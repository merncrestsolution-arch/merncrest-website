...
async function main() {
  ...
  const homepageOffers = [
    ...
    },
    {
      ...
      imageUrl: "/images/offers/mobile-app-development.png",
      bannerImageUrl: "/images/offers/mobile-app-development.png",
    ...
    },
    {
      ...
      imageUrl: "/images/offers/finance-management-system.png",
      bannerImageUrl: "/images/offers/finance-management-system.png",
  ...
  for (const offer of homepageOffers) {
    await prisma.homepageOffer.upsert({
      ...
      update: {
        ...
        imageUrl: "imageUrl" in offer ? offer.imageUrl ?? null : undefined,
        bannerImageUrl: "bannerImageUrl" in offer ? offer.bannerImageUrl ?? null : undefined,
      ...
      create: {
        ...
        badge: offer.badge,
        category: offer.category,
        imageUrl: "imageUrl" in offer ? offer.imageUrl ?? null : null,
        bannerImageUrl: "bannerImageUrl" in offer ? offer.bannerImageUrl ?? null : null,
        featuresJson: JSON.stringify(offer.features),
        gradientTheme: offer.gradientTheme,
        ctaText: "View Details",
        ctaUrl: `/offers/${offer.slug}`,
