        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center bg-black/40 dark:bg-background/40 backdrop-blur-[2px]">
              <div className="glass-card p-6 border-white/20 max-w-xs">
                <h3 className="text-xl font-bold text-foreground mb-2">MERN · AWS · AI</h3>
                <p className="text-sm text-foreground/80 font-medium">
                  Enterprise software, built and supported in Sri Lanka — EN / TA / SI
                </p>
              </div>
            </div>
          </motion.div>
